							...
							<form:form modelAttribute="update_satellite_attr" method="post" action="${pageContext.request.contextPath}/satellite/aggiorna" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-6">
									...
									<spring:bind path="denominazione">
										<input type="text" name="denominazione" id="denominazione" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il denominazione" value="${update_satellite_attr.denominazione }" required>
									</spring:bind>
